...
from openrlhf.models import PRMLossLinearHead
from openrlhf.utils.distributed_sampler import DistributedSampler
from openrlhf.utils.utils import convert_token_to_id


class ProcessRewardModelTrainerLinearHead(ABC):
    """
    Trainer for training a process reward model with linear head.
    ...
    def __init__(
        ...
        self.loss_fn = PRMLossLinearHead(self.placeholder_token_id, self.reward_token_ids)
    ...
    def fit(self, args, consumed_samples=0, num_update_steps_per_epoch=None):
        ...
        for epoch in range(start_epoch, self.epochs):
            ...
            for data in self.train_dataloader:
                ...
                prm_loss, acc = self.loss_fn(inputs, rewards, labels, return_acc=True)
    ...
    def evaluate(self, eval_dataloader, steps=0):
        ...
        with torch.no_grad():
            ...
            for data in eval_dataloader:
                ...
                loss, acc = self.loss_fn(inputs, rewards, labels, return_acc=True)
